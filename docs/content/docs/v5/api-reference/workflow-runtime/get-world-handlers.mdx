...
Configured Worlds share the instance cached by
[`getWorld()`](/docs/api-reference/workflow-runtime/get-world). Legacy
environment-based Worlds keep a separate handler cache.
