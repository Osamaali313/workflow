...
Generic build settings and Nitro-specific options may also be placed in
[`workflow.config.ts`](/docs/foundations/configuration). Explicit
`nitro.options.workflow` values take precedence.
