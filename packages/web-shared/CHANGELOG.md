...
- [`7b4998f`](https://github.com/vercel/workflow/commit/7b4998f1c6f26113fe8fb67c07768d55bedbd39c) - Show event occurrence timestamps in the trace detail panel when present.

- [`a0c030a`](https://github.com/vercel/workflow/commit/a0c030ad1c37dc194b89b6a5be72f403eac8b5fd) - Extend `cn` with custom tailwind-merge class groups for the design-system typography and material utilities, and move it to its own `lib/cn` module.

- [`9b972a7`](https://github.com/vercel/workflow/commit/9b972a7dd36ba71d04c2f5f20f59cbfa8969abbb) - Thread workflow event occurrence timestamps into derived observability entity data.
